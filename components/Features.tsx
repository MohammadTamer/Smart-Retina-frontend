...
const Features: React.FC = () => {
  return (
    ...
    <section className="px-6 pt-28 pb-6 md:px-24 bg-[#e3f2fd]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {/* Card 1 */}
        <div className="bg-white/60 backdrop-blur-sm border border-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition text-center group">
          ...
          <h3 className="text-xl font-bold text-[#152066] mb-3">Fast Diagnosis</h3>
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition text-center group">
          ...
          <h3 className="text-xl font-bold text-[#152066] mb-3">High Accuracy</h3>
          <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition text-center group">
          ...
          <h3 className="text-xl font-bold text-[#152066] mb-3">Explainable Results</h3>
          <p className="text-gray-600 text-sm leading-relaxed">
