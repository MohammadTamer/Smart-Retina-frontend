...
const DiseasesPage = () => {
  return (
    <main className="min-h-screen font-sans bg-[#f8fafc] text-[#1e293b]">
      ...
      {/* --- Header Section --- */}
      <section className="pt-28 pb-12 md:pt-32 md:pb-20 text-center bg-gradient-to-b from-blue-50 to-white px-4">
        <h1 className="text-3xl md:text-5xl font-bold text-[#152066] mb-4 md:mb-6">
          Retinal Diseases We Detect
        </h1>
        <p className="max-w-3xl mx-auto text-base md:text-lg text-blue-800/70 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 space-y-8 md:space-y-12">
        {diseasesData.map((disease, index) => {
          ...
          return (
            <div
              key={index}
              className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-14 items-center bg-white rounded-3xl md:rounded-[2.5rem]
                  shadow-lg md:shadow-[0_20px_60px_rgba(21,32,102,0.12)] 
                  p-6 md:p-10
            ...
            >
              ...
              */}
              <div className={`space-y-4 md:space-y-6 order-2 ${isReversed ? 'md:order-1' : 'md:order-2'}`}>
                <h2 className="text-2xl md:text-3xl font-bold text-[#152066]">
                  {disease.title}
                </h2>
                ...
                <div className="flex flex-wrap gap-2 md:gap-4">
                  <span className="px-3 py-1 md:px-4 md:py-2 rounded-full bg-blue-100 text-blue-700 text-xs md:text-sm font-medium">
                    AI Detection
                  </span>
                  <span className="px-3 py-1 md:px-4 md:py-2 rounded-full bg-green-100 text-green-700 text-xs md:text-sm font-medium">
                    Early Diagnosis
                  </span>
                  <span className="px-3 py-1 md:px-4 md:py-2 rounded-full bg-purple-100 text-purple-700 text-xs md:text-sm font-medium">
                    Vision Risk
                  </span>
                </div>
